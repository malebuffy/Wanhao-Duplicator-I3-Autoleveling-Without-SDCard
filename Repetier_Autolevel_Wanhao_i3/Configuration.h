...
#define UI_PRINTER_COMPANY "MaleBuffy"
...
#define UI_SET_PRESET_HEATED_BED_TEMP_PLA 62
...
========== Start configuration string ==========
{
    ...
    "uiPrinterName": "Dup i3",
    "uiPrinterCompany": "LAVSTUDIA",
